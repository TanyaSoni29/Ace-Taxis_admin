      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <div className="flex items-center justify-between bg-white shadow rounded-lg p-4">
          ...
          <Button
            variant="contained"
            color="error"
            style={{ height: "40px", backgroundColor: "#ff5252" }}
          >
            Unavailable (All Day)
          </Button>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-4 space-y-4">
          <div className="flex justify-between">
            <Button
              variant="contained"
              style={{ width: "150px", backgroundColor: "#333333", color: "#fff" }}
            >
              Custom
            </Button>
            <Button
        ...
        <div className="bg-white shadow rounded-lg p-4 space-y-4">
          ...
          <div className="flex space-x-4">
            <Button
              variant="contained"
              style={{ width: "200px", backgroundColor: "#4caf50", color: "#fff" }}
            >
              Add Available Hours
            </Button>
            <Button
              variant="contained"
              style={{ width: "200px", backgroundColor: "#ff5252", color: "#fff" }}
            >
