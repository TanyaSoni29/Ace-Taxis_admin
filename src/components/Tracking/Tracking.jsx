...
import {
  ...
  const Tracking = () => {
	const { isLoaded } = useLoadScript({
	  googleMapsApiKey: 'AIzaSyD4pR99wUBL7JtFDAibNJnVAwBddoRLwZw', // Replace with your API key
	});
	...
	return (
	  <div className="flex h-screen bg-white pl-10">
		{/* Main Content */}
			...
			<div className="w-[30%] bg-white shadow-lg rounded-lg overflow-hidden">
			  ...
			  >
				<Table stickyHeader>
				  <TableHead>
					<TableRow>
					  <TableCell className="bg-gray-100 font-semibold">#</TableCell>
					  <TableCell className="bg-gray-100 font-semibold">Reg</TableCell>
					  <TableCell className="bg-gray-100 font-semibold">Last</TableCell>
					  <TableCell className="bg-gray-100 font-semibold">Speed</TableCell>
					</TableRow>
				  </TableHead>
				  <TableBody>
					{dataSource.map((row) => (
