...
function Sidebar() {
	...
	return (
		<div
			className={`${isCollapsed ? "w-[80px]" : "w-[280px]" } dark:bg-black-600 bg-light border-e border-e-gray-200 dark:border-e-black fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0 transition-all duration-300`}
		...
		>
			<div className='h-[70px] hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0'>
				...
				<button
					className='inline-flex items-center cursor-pointer leading-none ps-4 pe-4 font-medium text-[0.9375rem] outline-none justify-center flex-shrink-0 p-0 gap-0 size-[30px] rounded-lg border border-[#F1F1F4] dark:border-[#F1F1F4] bg-light text-[#99A1B7] hover:text-[#4B5675] toggle absolute start-full top-2/4 -translate-x-2/4 -translate-y-2/4'
					onClick={handleToggleArrow}
				>
					<KeyboardTabIcon className='toggle-active:rotate-180 transition-all duration-200 ' />
				</button>
			</div>
				...
				<div className='scrollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3'>
					<div className='list-none m-0 p-0 flex flex-col grow gap-0.5'>
						<div className='p-0 m-0'>
							<div className='p-0 m-0 flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]'>
								...
								<span className='flex items-center text-[#C4CADA] w-[20px] shrink-0 justify-end ms-1 me-[-10px]'>
									...
									<MinimizeOutlinedIcon className='text-2xs hidden menu-item-show:inline-flex' />
								</span>
							</div>
							<div className='p-0 m-0 items-center hidden flex-col gap-0.5 ps-[10px] relative before:absolute before:start-[20px] before:top-0 before:bottom-0 before:border-s before:border-gray-200'>
						...
						<div className='p-0 m-0 flex flex-col'>
							<div className='menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]'>
								<span className='menu-icon items-start text-[#99A1B7] dark:text-[#464852] w-[20px]'>
							...
							<div className='p-0 m-0 items-center hidden flex-col gap-0.5 ps-[10px] relative before:absolute before:start-[20px] before:top-0 before:bottom-0 before:border-s before:border-gray-200'>
								<div className='p-0 m-0 flex flex-col'>
									<div className='menu-link border border-transparent grow cursor-pointer gap-[14px] ps-[10px] pe-[10px] py-[8px]'>
										<span className='menu-bullet flex w-[6px] -start-[3px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary'></span>
									...
									<div className='p-0 m-0 items-center hidden flex-col gap-0.5 relative before:absolute before:start-[32px] ps-[22px] before:top-0 before:bottom-0 before:border-s before:border-gray-200'>
										<div className='p-0 m-0 flex flex-col'>
											<Link
										...
										<div className='p-0 m-0 flex flex-col-reverse'>
											<div className='menu-link border border-transparent grow cursor-pointer gap-[5px] ps-[10px] pe-[10px] py-[8px]'>
												<span className='menu-bullet flex w-[6px] -start-[3px] rtl:start-0 relative before:absolute before:top-0 before:size-[6px] before:rounded-full rtl:before:translate-x-1/2 before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary'></span>
												...
												<span className='flex items-center text-[#C4CADA] w-[20px] shrink-0 justify-end ms-1 me-[-10px]'>
													<AddOutlinedIcon className='text-2xs menu-item-show:hidden' />
													<MinimizeOutlinedIcon className='ki-filled ki-minus text-2xs hidden menu-item-show:inline-flex' />
												</span>
											</div>
